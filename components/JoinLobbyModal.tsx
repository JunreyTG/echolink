    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70" onClick={onClose} aria-modal="true" role="dialog">
      <div className="bg-white dark:bg-[#2f3136] rounded-lg shadow-2xl w-full max-w-sm mx-4 p-6" onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-xl font-bold text-black dark:text-white">Enter Password</h2>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">The lobby <span className="font-semibold text-black dark:text-white">"{lobby.name}"</span> is password protected.</p>
        <form onSubmit={handleSubmit}>
          <div className="mb-2">
            <label htmlFor="lobby-password-join" className="block text-xs font-bold uppercase text-gray-500 dark:text-gray-400 mb-2">
              Lobby Password
            </label>
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full bg-gray-100 dark:bg-[#202225] p-3 pl-10 pr-10 rounded-md text-black dark:text-white placeholder-gray-500 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
                    required
                    autoFocus
                />
                <button
                    ...
                    className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white"
